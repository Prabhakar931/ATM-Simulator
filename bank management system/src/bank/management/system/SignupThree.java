...
public class SignupThree extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent ae) {
         if (ae.getSource() == submit) {
            ...
            long cardPrefix = 5040936000000000L; // The first 12 digits of the card number
            long randomPart = Math.abs(random.nextLong() % 9000000L); // Generate a 7-digit random number
            String cardnumber = Long.toString(cardPrefix + randomPart);
            
            int pinNumber = random.nextInt(9000) + 1000;
            String pinnumber = Integer.toString(pinNumber);
